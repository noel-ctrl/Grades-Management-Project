...
{
    public partial class deleteGradeMainForm : Form
    {
        public deleteGradeMainForm()
        {
            InitializeComponent();
        }
        ...
        private void searchStudentIdButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (myReader.Read())
                {
                    ...
                    deleteGrade deleteGrade = new deleteGrade(studentId, studentName);
                    this.Hide();
                    deleteGrade.ShowDialog();
                    this.Show();
